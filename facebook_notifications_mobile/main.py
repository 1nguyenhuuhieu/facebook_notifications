...
def notifications_listener(driver):
    ...
    new_notification = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[4]/div/div[1]/div/div/div[2]/div/a')
    new_notification.click()

    time.sleep(3)

    group = driver.current_url.split("/")[4]
    post_id = driver.current_url.split("/")[5].split("=")[1].split("%")[0].split("&")[0]

    try:
        post_text = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[4]/div/div/div[6]/article[1]/div').text.lower().replace('\n', '-')
